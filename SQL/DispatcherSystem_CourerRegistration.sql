...
--
-- Table structure for table `CourerRegistration`
--

DROP TABLE IF EXISTS `CourerRegistration`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `CourerRegistration` (
  `ID` int(11) DEFAULT NULL,
  `fullName` varchar(100) DEFAULT NULL,
  `Adress` varchar(100) DEFAULT NULL,
  `pasportNumber` varchar(100) DEFAULT NULL,
  `phone` varchar(15) DEFAULT NULL,
  `gmail` varchar(50) DEFAULT NULL,
  `statusColum` varchar(15) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `CourerRegistration`
--
